...
static PyObject* pyopencv_cv_AffineFeature_create(PyObject* , PyObject* py_args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "O|OOOO:AffineFeature_create", (char**)keywords, &pyobj_backend, &pyobj_maxTilt, &pyobj_minTilt, &pyobj_tiltStep, &pyobj_rotateStepBase) &&
        pyopencv_to(pyobj_backend, backend, ArgInfo("backend", 0)) &&
        pyopencv_to(pyobj_maxTilt, maxTilt, ArgInfo("maxTilt", 0)) &&
        pyopencv_to(pyobj_minTilt, minTilt, ArgInfo("minTilt", 0)) &&
        pyopencv_to(pyobj_tiltStep, tiltStep, ArgInfo("tiltStep", 0)) &&
        pyopencv_to(pyobj_rotateStepBase, rotateStepBase, ArgInfo("rotateStepBase", 0)) )
    {
...
static PyObject* pyopencv_cv_SIFT_create(PyObject* , PyObject* py_args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "OOOOOO:SIFT_create", (char**)keywords, &pyobj_nfeatures, &pyobj_nOctaveLayers, &pyobj_contrastThreshold, &pyobj_edgeThreshold, &pyobj_sigma, &pyobj_descriptorType) &&
        ...
        pyopencv_to(pyobj_edgeThreshold, edgeThreshold, ArgInfo("edgeThreshold", 0)) &&
        pyopencv_to(pyobj_sigma, sigma, ArgInfo("sigma", 0)) &&
        pyopencv_to(pyobj_descriptorType, descriptorType, ArgInfo("descriptorType", 0)) )
    {
...
static PyObject* pyopencv_cv_calibrateRobotWorldHandEye(PyObject* , PyObject* py_args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "OOOO|OOOOO:calibrateRobotWorldHandEye", (char**)keywords, &pyobj_R_world2cam, &pyobj_t_world2cam, &pyobj_R_base2gripper, &pyobj_t_base2gripper, &pyobj_R_base2world, &pyobj_t_base2world, &pyobj_R_gripper2cam, &pyobj_t_gripper2cam, &pyobj_method) &&
        pyopencv_to(pyobj_R_world2cam, R_world2cam, ArgInfo("R_world2cam", 0)) &&
        pyopencv_to(pyobj_t_world2cam, t_world2cam, ArgInfo("t_world2cam", 0)) &&
        pyopencv_to(pyobj_R_base2gripper, R_base2gripper, ArgInfo("R_base2gripper", 0)) &&
        pyopencv_to(pyobj_t_base2gripper, t_base2gripper, ArgInfo("t_base2gripper", 0)) &&
        pyopencv_to(pyobj_R_base2world, R_base2world, ArgInfo("R_base2world", 1)) &&
        pyopencv_to(pyobj_t_base2world, t_base2world, ArgInfo("t_base2world", 1)) &&
        pyopencv_to(pyobj_R_gripper2cam, R_gripper2cam, ArgInfo("R_gripper2cam", 1)) &&
        pyopencv_to(pyobj_t_gripper2cam, t_gripper2cam, ArgInfo("t_gripper2cam", 1)) &&
        pyopencv_to(pyobj_method, method, ArgInfo("method", 0)) )
    {
...
static PyObject* pyopencv_cv_compile_args(PyObject* , PyObject* py_args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "O:compile_args", (char**)keywords, &pyobj_pkg) &&
        pyopencv_to(pyobj_pkg, pkg, ArgInfo("pkg", 0)) )
    {
...
static PyObject* pyopencv_cv_estimateAffine2D(PyObject* , PyObject* py_args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "OOO|O:estimateAffine2D", (char**)keywords, &pyobj_pts1, &pyobj_pts2, &pyobj_params, &pyobj_inliers) &&
        pyopencv_to(pyobj_pts1, pts1, ArgInfo("pts1", 0)) &&
        pyopencv_to(pyobj_pts2, pts2, ArgInfo("pts2", 0)) &&
        pyopencv_to(pyobj_inliers, inliers, ArgInfo("inliers", 1)) &&
...
static PyObject* pyopencv_cv_findEssentialMat(PyObject* , PyObject* py_args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "OOOOOOO|O:findEssentialMat", (char**)keywords, &pyobj_points1, &pyobj_points2, &pyobj_cameraMatrix1, &pyobj_cameraMatrix2, &pyobj_dist_coeff1, &pyobj_dist_coeff2, &pyobj_params, &pyobj_mask) &&
        ...
        pyopencv_to(pyobj_cameraMatrix1, cameraMatrix1, ArgInfo("cameraMatrix1", 0)) &&
        pyopencv_to(pyobj_cameraMatrix2, cameraMatrix2, ArgInfo("cameraMatrix2", 0)) &&
        pyopencv_to(pyobj_dist_coeff1, dist_coeff1, ArgInfo("dist_coeff1", 0)) &&
        pyopencv_to(pyobj_dist_coeff2, dist_coeff2, ArgInfo("dist_coeff2", 0)) &&
        pyopencv_to(pyobj_mask, mask, ArgInfo("mask", 1)) &&
        pyopencv_to(pyobj_params, params, ArgInfo("params", 0)) )
    {
...
static PyObject* pyopencv_cv_dnn_NMSBoxes(PyObject* , PyObject* py_args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "OOOO|OO:NMSBoxes", (char**)keywords, &pyobj_bboxes, &pyobj_scores, &pyobj_score_threshold, &pyobj_nms_threshold, &pyobj_eta, &pyobj_top_k) &&
...
static PyObject* pyopencv_cv_dnn_NMSBoxesRotated(PyObject* , PyObject* py_args, PyObject* kw)
{
    using namespace cv::dnn;
    ...
    const char* keywords[] = { "bboxes", "scores", "score_threshold", "nms_threshold", "eta", "top_k", NULL };
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "OOOO|OO:NMSBoxesRotated", (char**)keywords, &pyobj_bboxes, &pyobj_scores, &pyobj_score_threshold, &pyobj_nms_threshold, &pyobj_eta, &pyobj_top_k) &&
        pyopencv_to(pyobj_bboxes, bboxes, ArgInfo("bboxes", 0)) &&
        pyopencv_to(pyobj_scores, scores, ArgInfo("scores", 0)) &&
        pyopencv_to(pyobj_score_threshold, score_threshold, ArgInfo("score_threshold", 0)) &&
        pyopencv_to(pyobj_nms_threshold, nms_threshold, ArgInfo("nms_threshold", 0)) &&
...
static PyObject* pyopencv_cv_dnn_Net_readFromModelOptimizer(PyObject* , PyObject* py_args, PyObject* kw)
{
    using namespace cv::dnn;
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "OO:Net_readFromModelOptimizer", (char**)keywords, &pyobj_xml, &pyobj_bin) &&
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "OO:Net_readFromModelOptimizer", (char**)keywords, &pyobj_bufferModelConfig, &pyobj_bufferWeights) &&
...
static PyObject* pyopencv_cv_dnn_blobFromImage(PyObject* , PyObject* py_args, PyObject* kw)
{
    using namespace cv::dnn;
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "O|OOOOOO:blobFromImage", (char**)keywords, &pyobj_image, &pyobj_scalefactor, &pyobj_size, &pyobj_mean, &pyobj_swapRB, &pyobj_crop, &pyobj_ddepth) &&
        pyopencv_to(pyobj_image, image, ArgInfo("image", 0)) &&
        pyopencv_to(pyobj_scalefactor, scalefactor, ArgInfo("scalefactor", 0)) &&
        pyopencv_to(pyobj_size, size, ArgInfo("size", 0)) &&
        pyopencv_to(pyobj_mean, mean, ArgInfo("mean", 0)) &&
...
static PyObject* pyopencv_cv_dnn_blobFromImages(PyObject* , PyObject* py_args, PyObject* kw)
{
    using namespace cv::dnn;
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "O|OOOOOO:blobFromImages", (char**)keywords, &pyobj_images, &pyobj_scalefactor, &pyobj_size, &pyobj_mean, &pyobj_swapRB, &pyobj_crop, &pyobj_ddepth) &&
        pyopencv_to(pyobj_images, images, ArgInfo("images", 0)) &&
        pyopencv_to(pyobj_scalefactor, scalefactor, ArgInfo("scalefactor", 0)) &&
        pyopencv_to(pyobj_size, size, ArgInfo("size", 0)) &&
        pyopencv_to(pyobj_mean, mean, ArgInfo("mean", 0)) &&
...
static PyObject* pyopencv_cv_dnn_getAvailableTargets(PyObject* , PyObject* py_args, PyObject* kw)
{
    using namespace cv::dnn;
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "O:getAvailableTargets", (char**)keywords, &pyobj_be) &&
...
static PyObject* pyopencv_cv_dnn_imagesFromBlob(PyObject* , PyObject* py_args, PyObject* kw)
{
    using namespace cv::dnn;
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "O|O:imagesFromBlob", (char**)keywords, &pyobj_blob_, &pyobj_images_) &&
...
static PyObject* pyopencv_cv_dnn_readNet(PyObject* , PyObject* py_args, PyObject* kw)
{
    using namespace cv::dnn;
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "O|OO:readNet", (char**)keywords, &pyobj_model, &pyobj_config, &pyobj_framework) &&
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "OO|O:readNet", (char**)keywords, &pyobj_framework, &pyobj_bufferModel, &pyobj_bufferConfig) &&
        pyopencv_to(pyobj_framework, framework, ArgInfo("framework", 0)) &&
...
static PyObject* pyopencv_cv_dnn_readNetFromCaffe(PyObject* , PyObject* py_args, PyObject* kw)
{
    using namespace cv::dnn;
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "O|O:readNetFromCaffe", (char**)keywords, &pyobj_prototxt, &pyobj_caffeModel) &&
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "O|O:readNetFromCaffe", (char**)keywords, &pyobj_bufferProto, &pyobj_bufferModel) &&
...
static PyObject* pyopencv_cv_dnn_readNetFromModelOptimizer(PyObject* , PyObject* py_args, PyObject* kw)
{
    using namespace cv::dnn;
    ...
    const char* keywords[] = { "xml", "bin", NULL };
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "OO:readNetFromModelOptimizer", (char**)keywords, &pyobj_xml, &pyobj_bin) &&
        pyopencv_to(pyobj_xml, xml, ArgInfo("xml", 0)) &&
        pyopencv_to(pyobj_bin, bin, ArgInfo("bin", 0)) )
    {
    ...
    const char* keywords[] = { "bufferModelConfig", "bufferWeights", NULL };
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "OO:readNetFromModelOptimizer", (char**)keywords, &pyobj_bufferModelConfig, &pyobj_bufferWeights) &&
        pyopencv_to(pyobj_bufferModelConfig, bufferModelConfig, ArgInfo("bufferModelConfig", 0)) &&
        pyopencv_to(pyobj_bufferWeights, bufferWeights, ArgInfo("bufferWeights", 0)) )
    {
...
static PyObject* pyopencv_cv_dnn_readNetFromONNX(PyObject* , PyObject* py_args, PyObject* kw)
{
    using namespace cv::dnn;
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "O:readNetFromONNX", (char**)keywords, &pyobj_onnxFile) &&
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "O:readNetFromONNX", (char**)keywords, &pyobj_buffer) &&
...
static PyObject* pyopencv_cv_dnn_readNetFromTensorflow(PyObject* , PyObject* py_args, PyObject* kw)
{
    using namespace cv::dnn;
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "O|O:readNetFromTensorflow", (char**)keywords, &pyobj_model, &pyobj_config) &&
        pyopencv_to(pyobj_model, model, ArgInfo("model", 0)) &&
        pyopencv_to(pyobj_config, config, ArgInfo("config", 0)) )
    {
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "O|O:readNetFromTensorflow", (char**)keywords, &pyobj_bufferModel, &pyobj_bufferConfig) &&
        pyopencv_to(pyobj_bufferModel, bufferModel, ArgInfo("bufferModel", 0)) &&
        pyopencv_to(pyobj_bufferConfig, bufferConfig, ArgInfo("bufferConfig", 0)) )
    {
...
static PyObject* pyopencv_cv_dnn_readNetFromTorch(PyObject* , PyObject* py_args, PyObject* kw)
{
    using namespace cv::dnn;
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "O|OO:readNetFromTorch", (char**)keywords, &pyobj_model, &pyobj_isBinary, &pyobj_evaluate) &&
        pyopencv_to(pyobj_model, model, ArgInfo("model", 0)) &&
...
static PyObject* pyopencv_cv_dnn_readTensorFromONNX(PyObject* , PyObject* py_args, PyObject* kw)
{
    using namespace cv::dnn;
    ...
    const char* keywords[] = { "path", NULL };
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "O:readTensorFromONNX", (char**)keywords, &pyobj_path) &&
        pyopencv_to(pyobj_path, path, ArgInfo("path", 0)) )
    {
...
static PyObject* pyopencv_cv_dnn_readTorchBlob(PyObject* , PyObject* py_args, PyObject* kw)
{
    using namespace cv::dnn;
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "O|O:readTorchBlob", (char**)keywords, &pyobj_filename, &pyobj_isBinary) &&
        pyopencv_to(pyobj_filename, filename, ArgInfo("filename", 0)) &&
        pyopencv_to(pyobj_isBinary, isBinary, ArgInfo("isBinary", 0)) )
    {
...
static PyObject* pyopencv_cv_dnn_shrinkCaffeModel(PyObject* , PyObject* py_args, PyObject* kw)
{
    using namespace cv::dnn;
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "OO|O:shrinkCaffeModel", (char**)keywords, &pyobj_src, &pyobj_dst, &pyobj_layersTypes) &&
        pyopencv_to(pyobj_src, src, ArgInfo("src", 0)) &&
        pyopencv_to(pyobj_dst, dst, ArgInfo("dst", 0)) &&
...
static PyObject* pyopencv_cv_dnn_writeTextGraph(PyObject* , PyObject* py_args, PyObject* kw)
{
    using namespace cv::dnn;
    ...
    if( PyArg_ParseTupleAndKeywords(py_args, kw, "OO:writeTextGraph", (char**)keywords, &pyobj_model, &pyobj_output) &&
        pyopencv_to(pyobj_model, model, ArgInfo("model", 0)) &&
